...
export default function ProductGallery({
  ...
  // Get the appropriate image based on current view
  const getImage = () => {
  ...
  return (
    <div className="relative text-neutral-700">
      <div
        ...
        className="aspect-square bg-zinc-800 relative rounded-lg overflow-hidden cursor-zoom-in group"
